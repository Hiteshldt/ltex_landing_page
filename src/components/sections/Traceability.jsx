...
export default function Traceability() {
  ...
  const events = [
    { code: "0x4a…f29c", stage: "FARM", actor: "FPO Cluster · Coimbatore N-7", time: "T+0", note: "Biomass received · 218 kg · GPS verified" },
    { code: "0x8b…2d11", stage: "EXTRACT", actor: "Hub-02 · Pollachi", time: "T+18h", note: "Fiber extraction complete · 12.4% yield" },
              ...
              <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 12 }}>
                {events.map((e, i) => {
                  ...
                  return (
                    ...
                    >
                      <span style={{ width: 8, height: 8, borderRadius: "50%", background: active ? "var(--green)" : "#3a4250", boxShadow: active ? "0 0 0 5px rgba(24,194,90,0.22)" : "none", transition: "all 320ms ease" }} />
            ...
            <div className="col gap-24" style={{ height: "100%" }}>
              ...
              <div className="card" style={{ flex: 1 }}>
                ...
                <p className="body" style={{ marginTop: 12, marginBottom: 0 }}>
                  Buyers increasingly want provable origin — not a marketing line. With LeafTex, your sustainability story is auditable down to a specific farmer cooperative.
                </p>
              </div>
            </div>
          </Reveal>
