...
import StemCrossSection from "@/components/ui/StemCrossSection";
    ...
    <header id="top" style={{ position: "relative", paddingTop: 132, paddingBottom: 72 }}>
      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        ...
        <Reveal delay={120}>
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
              <div>
                <h1 className="display-xl" style={{ margin: 0, maxWidth: "20ch" }}>
                  Agricultural waste,<br />
                  re-engineered into<br />
                  next-generation <span className="green-word">sustainable</span> materials.
                </h1>
                <p className="body-l" style={{ maxWidth: "52ch", marginTop: 28, marginBottom: 0 }}>
                  LeafTex is a biomaterials platform that converts agricultural waste —{" "}
                  <strong style={{ color: "var(--ink)" }}>banana, pineapple, and algae</strong>, the
                  120M tons burned every year — into three commercial-grade outputs: high-tenacity
                  fiber, vegan leather, and an edible film coating that extends produce shelf life by
                  up to 60%.
                </p>
                <div style={{ display: "flex", gap: 12, marginTop: 28, flexWrap: "wrap" }}>
                  <Link href="/products" className="btn btn-green">
                    Explore our materials <span className="arrow">→</span>
                  </Link>
        ...
        <Reveal delay={300}>
          ...
          >
            {[
              ["100%", "Biomass utilization", "vs. 15–20% industry avg"],
              ["3×", "Upcycled sources", "banana · pineapple · algae"],
              ["40–60%", "Shelf-life uplift", "verified on fresh produce"],
              ["150M+ t", "Annual feedstock", "agricultural & marine waste"],
            ].map(([k, v, sub], i) => (
              <div
                key={v}
                style={{ padding: "26px 22px", borderRight: i < 3 ? "1px solid var(--rule)" : "none" }}
              >
